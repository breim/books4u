...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { cr: @professor.cr, email: @professor.email, horario: @professor.horario, nota_pf: @professor.nota_pf, nota_pi: @professor.nota_pi, price: @professor.price, ranking: @professor.ranking, user_id: @professor.user_id }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { cr: @professor.cr, email: @professor.email, horario: @professor.horario, nota_pf: @professor.nota_pf, nota_pi: @professor.nota_pi, price: @professor.price, ranking: @professor.ranking, user_id: @professor.user_id }
    assert_redirected_to professor_path(assigns(:professor))
  end
